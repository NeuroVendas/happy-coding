...
- GitHub Device Flow implementado; lista repositórios públicos, token protegido pelo sistema e sem exposição ao renderer. **Falta o Client ID público do OAuth App do proprietário** em `desktop/integrations.json`; ver `desktop/CONNECTIONS_SETUP.md`.
